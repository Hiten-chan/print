...
<div id="page">
    <div id="menu">
        <!-- Меню -->
        <div class="tab">
            <button name="1" class="links active" onclick="openLang(event,'HTML')">История заказов</button>
            <button name="2" class="links"  onclick="openLang(event,'CSS')">Создать заказ</button>
            <button name="3" class="links" onclick="openLang(event,'PHP')">Настройки аккаунта</button>
            <button name="4" class="links" onclick="openLang(event,'JS')">Сменить пароль</button>
